...
def main():
    ...
    output_folder = "/mnt/nas1/zhanghong/project/data-juicer/data/laion/diffusion_db/test"
    input_jsonl = os.path.join(output_folder, "generated_images.jsonl")
    output_jsonl = os.path.join(output_folder, "caption-bboxbyqwen.jsonl")
