...
# 图像文件夹路径
image_folder = '/mnt/nas1/zhanghong/project/data-juicer/data/laion/diffusion_db/images_test'
# 输出 JSONL 文件路径
output_file = '/mnt/nas1/zhanghong/project/data-juicer/data/laion/diffusion_db/test/generated_images.jsonl'
# 获取所有子文件夹的路径
